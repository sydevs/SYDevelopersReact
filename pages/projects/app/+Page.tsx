      ...
      <div className="prose prose-sm max-w-none space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Increasingly people who are interested meditation look for a phone app as their
              first interest in meditation. This is especially true amongst the younger more
              technically savvy population. The idea of trying meditation is increasingly popular.
              Free meditation apps are an accessible solution for people who don&apos;t want to
              commit to a class.
            </p>
            <p>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              The primary feature of this app will be a library of guided meditations. This is
              what most people look for in a meditation app.
            </p>
            <p>
              The plan is to start with a very small but professional app, and then expand the
              features based on user testing and feedback. Future iterations of the app may
              include tracking personal goals, and recommending guided meditations based on what
              the user tells us that they feel on their hands.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Although this will not be ready in the first iteration of the app, it will be
              possible to use the app to direct seekers to attend local public programs. The first
              step would be to integrate the app with the{' '}
            ...
            <p>
              ...
              users&apos; phones when there is a special event in their area, or when they travel
              to a new location.
            </p>
          </div>
        </div>
